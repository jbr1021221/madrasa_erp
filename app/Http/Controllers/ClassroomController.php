...
class ClassroomController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'class_id' => 'required|string|size:3|regex:/^[0-9]{3}$/|unique:classrooms,class_id',
            ...
            'fees.*.type' => 'required|in:One Time,Monthly,Quarterly,Half-Yearly,Yearly'
        ]);
    ...
    public function update(Request $request, Classroom $classroom)
    {
        $validated = $request->validate([
            ...
            'class_id' => 'required|string|size:3|regex:/^[0-9]{3}$/|unique:classrooms,class_id,' . $classroom->id,
            'sections' => 'required|string',
            'max_students_per_section' => 'required|integer|min:1',
            'admission_fee' => 'required|numeric|min:0',
            'fees' => 'nullable|array',
