                    ...
                    <tr>
                        ...
                        <td style="display:flex;gap:6px;justify-content:center">
                            <a href="{{ route('payments.receipt', $payment) }}" target="_blank" class="action-btn"
                                title="View Receipt">View</a>
                            <button type="button" class="action-btn edit"
                                onclick='openEditPaymentModal(@json($payment))'
                                title="Edit Payment">Edit</button>
                            <form action="{{ route('payments.destroy', $payment) }}" method="POST"
                                style="display:inline-block;margin:0" class="delete-payment-form">
                                @csrf
                                @method('DELETE')
                                <button type="button" class="action-btn delete" title="Delete Payment"
