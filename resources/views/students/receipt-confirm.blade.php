    ...
    <div style="background:var(--card);border-radius:var(--radius);padding:32px;border:1px solid rgba(255,255,255,0.15);text-align:center">
        ...
        <div style="background:rgba(255,255,255,0.05);padding:24px;border-radius:8px;margin-bottom:24px;text-align:left">
            ...
            @php
                ...
                $latestPayment = $student->payments()->latest('id')->first();
            ...
            <div style="margin-top:20px;padding-top:20px;border-top:1px solid rgba(255,255,255,0.1)">
                        ...
                        <table style="width:100%;border-collapse:collapse">
                            <thead>
                                <tr style="border-bottom:1px solid rgba(255,255,255,0.1)">
                                    <th style="text-align:left;padding:8px;color:var(--muted);font-size:13px">Description</th>
                ...
                @else
                    ...
                    <div style="display:flex;justify-content:space-between;align-items:center">
                        <div>
                            ...
                            <p style="color:#4caf50;font-weight:700;font-size:24px;margin:0">৳{{ number_format($latestPayment->amount, 2) }}</p>
                        </div>
                        <div style="text-align:right">
                            <label style="display:block;color:var(--muted);font-size:12px;margin-bottom:4px">Payment Mode</label>
                            <p style="color:var(--text);font-weight:600;margin:0">{{ $latestPayment->payment_mode }}</p>
                        </div>
                    </div>
                @endif
                ...
                <div style="margin-top:12px;padding-top:12px;border-top:1px solid rgba(255,255,255,0.05);display:flex;justify-content:space-between">
                    ...
                    <div style="text-align:right">
                        ...
                        <p style="color:var(--text);font-weight:600;margin:0">{{ \Carbon\Carbon::parse($latestPayment->payment_date)->format('d M, Y') }}</p>
                    </div>
                </div>
            </div>
            @endif
        ...
        <div style="display:flex;gap:12px;justify-content:center;flex-wrap:wrap">
            ...
            <a href="javascript:void(0)" onclick="printReceipt('{{ route('students.receipt.view', $student) }}')" class="btn" style="display:inline-flex;align-items:center;gap:8px;background:#4caf50;color:#fff">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            {{-- Share via WhatsApp --}}
            <a href="javascript:void(0)" onclick="shareViaWhatsApp()" class="btn" style="display:inline-flex;align-items:center;gap:8px;background:#25D366;color:#fff">
            ...
            {{-- Share via Email --}}
            <a href="javascript:void(0)" onclick="shareViaEmail()" class="btn" style="display:inline-flex;align-items:center;gap:8px;background:#EA4335;color:#fff">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <a href="javascript:void(0)" onclick="shareReceipt()" id="webShareBtn" class="btn" style="display:none;align-items:center;gap:8px;background:#2196F3;color:#fff">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <a href="{{ route('students.admission-form.download', $student) }}" class="btn" style="display:inline-flex;align-items:center;gap:8px;background:#2196F3;color:#fff">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
async function shareReceipt() {
    ...
    try {
        ...
        const file = new File([blob], `receipt_${studentId}.pdf`, { type: 'application/pdf' });
